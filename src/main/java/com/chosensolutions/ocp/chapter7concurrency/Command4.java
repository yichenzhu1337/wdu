...
public class Command4 implements Runnable {

    public void run() {

        try {
            //String[] cmdScript = new String[]{"/bin/bash", "path/to/myScript.sh"};
            Process procScript = Runtime.getRuntime().exec("sh " + System.getProperty("user.dir") + "/src/main/java/com/chapter7concurrency/test4.sh");
